...
{ path : 'addfiles', loadChildren: () => import('./addfiles/addfiles.module').then(m => m.AddfilesModule), canActivate: [AuthGuard] } , 
{ path : 'filescreate', loadChildren: () => import('./filescreate/filescreate.module').then(m => m.FilescreateModule), canActivate: [AuthGuard] } , 
];
